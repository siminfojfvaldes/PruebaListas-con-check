...
Begin WebPage WebPage1
   ...
   Begin ListaImagenes list_Imagenes
      alturaTotal     =   0
      Cursor          =   0
      Enabled         =   True
      Height          =   238
   ...
   Begin WebTextField text_Fecha
      ...
      _VerticalPercent=   0.0
   End
   Begin WebTextField text_Diagnostico
      AutoCapitalize  =   True
      AutoComplete    =   True
      AutoCorrect     =   True
      CueText         =   ""
   ...
   Begin WebCheckbox check_EP
      ...
      _VerticalPercent=   0.0
   End
   Begin ListaControles2 ListControles1
      Cursor          =   0
      Enabled         =   True
      Height          =   135
      HelpTag         =   ""
...
#tag Events Button1
	#tag Event
		Sub Action()
		  dim fila as new FilaListaImagenes
...
#tag Events ListControles1
	#tag Event
		Sub Abierto()
		  ...
		  c.TipoColumna = "TextBox"
		  c.Width = 33
		  
		  c.TipoColumna = "TextBox"
		  
		  me.Columnas.Append(c)
		  c.TipoColumna = "Popup"
		  me.Columnas.Append(c)
		  c.TipoColumna = "CheckBox"
		  me.Columnas.Append(c)
		  
		  me.ColumnCount = 4
		  
		  me.ColumnWidths = "50%,30%,*,*"
